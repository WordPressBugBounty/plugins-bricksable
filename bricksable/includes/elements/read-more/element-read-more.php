...
class Bricksable_Read_More extends \Bricks\Element {
	...
	public function set_controls() {
		...
		$this->controls['scrollBacktoTop']       = array(
			'tab'         => 'content',
			'group'       => 'settings',
			'label'       => esc_html__( 'Scroll Back to Top (Close)', 'bricksable' ),
			'type'        => 'checkbox',
			'inline'      => true,
			'description' => esc_html__( 'Clicking close will automatically scroll you to the top of the element or with a CSS ID', 'bricksable' ),
			'required'    => array( 'startOpen', '=', '' ),
		);
		$this->controls['scrollBacktoTopTarget'] = array(
			'tab'         => 'content',
			'group'       => 'settings',
			'label'       => esc_html__( 'Scroll Back Target Method', 'bricksable' ),
			'type'        => 'select',
			'options'     => array(
				'element' => esc_html__( 'Element', 'bricksable' ),
				'css-id'  => esc_html__( 'CSS ID', 'bricksable' ),
			),
			'inline'      => true,
			'default'     => 'element',
		...
		$this->controls['scrollBacktoTopCssId']  = array(
			'tab'            => 'content',
			'group'          => 'settings',
			'label'          => esc_html__( 'Scroll to CSS ID', 'bricksable' ),
			'class'          => 'ltr',
			'type'           => 'text',
			'hasDynamicData' => true,
			'description'    => esc_html__( 'No spaces. No pound (#) sign.', 'bricksable' ),
			'required'       => array( 'scrollBacktoTopTarget', '=', 'css-id' ),
		);
