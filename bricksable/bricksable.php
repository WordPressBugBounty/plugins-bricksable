...
require_once 'includes/class-bricksable-migration.php';
 ...
 */
function bricksable() {
	$instance = Bricksable::instance( __FILE__, '1.6.82' );
	...
	// Initialize data migration (Action Scheduler).
	Bricksable_Migration::init();
